...
interface IGovernance {
    ...
    event DepositLQTY(address indexed user, uint256 indexed lqtyAmount);
    ...
    /// @param lqtyReceived Amount of LQTY tokens actually withdrawn
    event WithdrawLQTY(address indexed user, uint256 indexed lqtyReceived);
    ...
    /// @notice Withdraws LQTY and claims any accrued LUSD and ETH rewards
