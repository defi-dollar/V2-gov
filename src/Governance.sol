...
contract Governance is MultiDelegateCall, ReentrancyGuard, Ownable, IGovernance {
    ...
    function depositLQTYViaPermit(uint256 _lqtyAmount, PermitParams calldata _permitParams) external {
        require(msg.sender == _permitParams.owner, "Governance: owner-not-sender");
    ...
    function registerInitiative(address _initiative) external nonReentrant {
        ...
        uint256 totalUserDepositedLQTY = userState.unallocatedLQTY + userState.allocatedLQTY;
        ...
        require(
            ...
            lqtyToVotes(totalUserDepositedLQTY, epochStart(), totalUserOffset)
